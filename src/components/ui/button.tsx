  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass: "glass-button text-foreground hover:text-primary-foreground organic-border",
        hero: "bg-gradient-primary text-primary-foreground hover:scale-105 hover:shadow-glow-strong organic-border font-semibold",
        install: "bg-gradient-secondary text-accent-foreground hover:scale-105 hover:shadow-glow organic-border-alt font-bold",
        camera: "glass-card text-foreground hover:text-primary-foreground hover:bg-primary/20 rounded-full",
        floating: "glass-card text-foreground hover:text-primary-foreground hover:shadow-glow-strong rounded-full glow-pulse"
      },
      size: {
